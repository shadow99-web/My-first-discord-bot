...
module.exports = {
  data: new SlashCommandBuilder()
    .setName("serverstats")
    .setDescription("💙 View futuristic join/leave server stats (SHADOW style)."),

  name: "serverstats",
  description: "💙 View futuristic join/leave server stats (prefix + slash)",
  ...
  async execute(context) {
    ...
    try {
      ...
      const embed = new EmbedBuilder()
        ...
        .setDescription(
          `📅 **Today:** +${todayData.joins - todayData.leaves} (**+${todayData.joins}**, **-${todayData.leaves}**)
🕒 **Last 7 Days:** +${last7.joins - last7.leaves} (**+${last7.joins}**, **-${last7.leaves}**)
🌐 **Last 30 Days:** +${last30.joins - last30.leaves} (**+${last30.joins}**, **-${last30.leaves}**)

> Showing smooth futuristic chart with 💙 SHADOW design.`
        )
        .setImage(chartUrl)
        .setThumbnail(guild.iconURL({ dynamic: true }))
        .setFooter({
          text: `Server: ${guild.name} • Generated by SHADOW`,
      ...
      const errorMsg = "⚠️ Something went wrong fetching server stats.";
